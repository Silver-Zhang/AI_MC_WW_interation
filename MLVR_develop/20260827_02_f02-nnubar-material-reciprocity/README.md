...
| 方案 | 做法 | 代价 / 风险 | 推荐度 |
|---|---|---|---|
| A | 重新筛选 `10005` 最大有效裂变迁移 g4→g1；先做其纯材料及 `10005:10001=0.5:0.5` 混合材料 pilot，均通过后冻结两 case × 五独立对的 formal。 | NNUBAR=1 裂变截面远小于 `10001`，pilot 需较多 histories；混合 case 的总响应会包含 NNUBAR=2 贡献。 | ★推荐 |
...
- **遗留问题 / 后续待办**：本任务关闭 NNUBAR=1/多材料裂变门槛，但不能验证更广群对、空间混合或裂变与 density mesh 的组合。F02 的 A 复核仍必须明确审查“更多几何/边界”要求，且不能把本任务结果外推至 photon、CE、AIS 或并行环境。
